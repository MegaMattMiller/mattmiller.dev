...
const Navbar:FC = () => {
  return (
    <div className="navbar bg-neutral text-neutral-content w-full flex flex-row justify-start">
      ...
      <a className="md:text-[4vw] lg:text-[2vw] text-xl ml-0" href="https://dev.to/megamattmiller" title='dev.to link'><FaDev /></a>
      <a className="md:text-[4vw] lg:text-[2vw] text-xl ml-0" href="mailto:matt@mattmiller.dev" title='email link'><FaEnvelopeSquare /></a>
    </div>
  )
}
